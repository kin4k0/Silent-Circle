...
export async function POST(request) {
  ...
  【ルール】
  1. 投稿内容に「死ね」「殺す」「バカ」「デブ」「キモイ」などの、具体的な個人への直接的な「罵詈雑言」が含まれている場合のみ { "isSafe": false } としてください。
  2. それ以外の「挨拶」「頑張る」「就活」「悩み」「ゲームの感想」などは、たとえ死や暴力に関する暴力的な言葉が混ざっていても、すべて「isSafe: true」としてください。
